...
Video.create(title:"The Thin Red Line",description:"Terrence Malick's adaptation of James Jones' autobiographical 1962 novel, focusing on the conflict at Guadalcanal during the second World War.",small_cover_url:"/tmp/thin_red_line.jpg",large_cover_url:"/tmp/thin_red_line_large.jpg",category:Category.find_by(name: "Indie Films"))
Video.create(title:"The Tree of Life",description:"The story of a family in Waco, Texas in 1956. The eldest son witnesses the loss of innocence and struggles with his parents' conflicting teachings.",small_cover_url:"/tmp/tree_of_life.jpg",large_cover_url:"/tmp/tree_of_life_large.jpg",category:Category.find_by(name: "Indie Films"))
Video.create(title:"Her",description:"A lonely writer develops an unlikely relationship with his newly purchased operating system that's designed to meet his every need.",small_cover_url:"/tmp/her.jpg",large_cover_url:"/tmp/her_large.jpg",category:Category.find_by(name: "Indie Films"))
...
#Action/Adventure
Video.create(title:"The Dark Knight Rises",description:"A new menace emerges and the Dark Knight rises again to protect the city from a merciless terrorist with the help of anti-heroine Selina Kyle.",small_cover_url:"/tmp/dark_knight_rises.jpg",large_cover_url:"/tmp/dark_knight_rises_large.jpg",category:Category.find_by(name: "Action/Adventure"))
...
Video.create(title:"The Man from Nowhere",description:"A quiet pawnshop keeper with a violent past takes on a drug- and organ trafficking ring in hope of saving the child who is his only friend.",small_cover_url:"/tmp/man_from_nowhere.jpg",large_cover_url:"/tmp/man_from_nowhere_large.jpg",category:Category.find_by(name: "Action/Adventure"))
...
#Drama
Video.create(title:"Casablanca",description:"Set in unoccupied Africa during the early days of World War II: An American expatriate meets a former lover, with unforeseen complications.",small_cover_url:"/tmp/casablanca.jpg",large_cover_url:"/tmp/casablanca_large.jpg",category:Category.find_by(name: "Drama"))
Video.create(title:"Shadowlands",description:"Noted author and scholar finds love, then must endure its loss...",small_cover_url:"/tmp/shadowlands.jpg",large_cover_url:"/tmp/shadowlands_large.jpg",category:Category.find_by(name: "Drama"))
Video.create(title:"500 Days of Summer",description:"An offbeat romantic comedy about a woman who doesn't believe true love exists, and the young man who falls for her.",small_cover_url:"/tmp/500_days_of_summer.jpg",large_cover_url:"/tmp/500_days_of_summer_large.jpg",category:Category.find_by(name: "Drama"))
...
Video.create(title:"Open Range",description:"A former gunslinger is forced to take up arms again when he and his cattle crew are threatened by a corrupt lawman.",small_cover_url:"/tmp/open_range.jpg",large_cover_url:"/tmp/open_range_large.jpg",category:Category.find_by(name: "Drama"))
Video.create(title:"Inception",description:"A thief who steals corporate secrets through use of dream-sharing technology is given the inverse task of planting an idea into the mind of a CEO.",small_cover_url:"/tmp/inception.jpg",large_cover_url:"/tmp/inception_large.jpg",category:Category.find_by(name: "Drama"))
